 ...
 */
static inline REAL8 XLALCalculateA5(
 ...
 */
static inline REAL8 XLALCalculateA6(
    const REAL8 UNUSED eta /**<< Symmetric mass ratio */
) {
  return 184.0;
}
 ...
 */
UNUSED static int XLALCalculateEOBACoefficients(
    EOBACoefficients
        *const coeffs, /**<< A coefficients (populated in function) */
    const REAL8 eta    /**<< Symmetric mass ratio */
) {
  REAL8 eta2, eta3;
  REAL8 a4, a5, a6;
  ...
  /* Note that the definitions of a5 and a6 DO NOT correspond to those in the
   * paper */
  /* Therefore we have to multiply the results of our a5 and a6 finctions by
   * eta. */
  ...
  coeffs->d0 = 4. * a4 * a4 + 4. * a4 * a5 + a5 * a5 - a4 * a6 + 16. * a6 +
               (32. * a4 + 16. * a5 - 8. * a6) * eta + 4. * a4 * eta2 +
               32. * eta3;
  coeffs->d1 = 4. * a4 * a4 + a4 * a5 + 16. * a5 + 8. * a6 +
               (32. * a4 - 2. * a6) * eta + 32. * eta2 + 8. * eta3;
  coeffs->d2 =
      16. * a4 + 8. * a5 + 4. * a6 + (8. * a4 + 2. * a5) * eta + 32. * eta2;
...
UNUSED static int XLALSimIMREOBCalcFacWaveformCoefficients(
  ...
  coeffs->rho22v4 =
      -20555. / 10584. +
      (chiS * chiS + 2. * chiA * chiS * dM + chiA * chiA * dM2) / 2. -
  ...
  if (dM2) {
    ...
    /*coeffs->rho21v3   = (-567.*chiA*chiA*chiA - 1701.*chiA*chiA*chiS*dM
                        + chiA*(-4708. + 1701.*chiS*chiS - 2648.*eta)*(-1.
       + 4.*eta)
                        + chiS* dM3 *(4708. - 567.*chiS*chiS
                        + 1816.*eta))/(2688.*dM3);*/
    coeffs->rho21v2 = -59. / 56. + (23. * eta) / 84. - 9. / 32. * a2;
    coeffs->rho21v3 = 1177. / 672. * a - 27. / 128. * a3;
    coeffs->rho21v4 = -47009. / 56448. - (865. * a2) / 1792. -
                      (405. * a2 * a2) / 2048. - (10993. * eta) / 14112. +
                      (617. * eta2) / 4704.;
    coeffs->rho21v5 = (-98635. * a) / 75264. + (2031. * a * a2) / 7168. -
                      (1701. * a2 * a3) / 8192.;
    coeffs->rho21v6 = 7613184941. / 2607897600. + (9032393. * a2) / 1806336. +
                      (3897. * a2 * a2) / 16384. - (15309. * a3 * a3) / 65536.;
    coeffs->rho21v6l = -107. / 105.;
    coeffs->rho21v7 = (-3859374457. * a) / 1159065600. -
                      (55169. * a3) / 16384. + (18603. * a2 * a3) / 65536. -
  ...
  if (dM2) {
    ...
    coeffs->rho33v3 =
        (chiS * dM * (-4. + 5. * eta) + chiA * (-4. + 19. * eta)) / (6. * dM);
    coeffs->rho33v4 =
        -6719. / 3960. + a2 / 2. - (1861. * eta) / 990. + (149. * eta2) / 330.;
  ...
  coeffs->rho32v2 = (-4. * a2 * eta2) / (9. * m1Plus3eta2) +
                    (328. - 1115. * eta + 320. * eta2) / (270. * m1Plus3eta);
  coeffs->rho32v3 = (2. * (45. * a * m1Plus3eta3 -
                           a * eta *
                               (328. - 2099. * eta +
                                5. * (733. + 20. * a2) * eta2 - 960. * eta3))) /
                    (405. * m1Plus3eta3);
  coeffs->rho32v4 = a2 / 3. + (-1444528. + 8050045. * eta - 4725605. * eta2 -
                               20338960. * eta3 + 3085640. * eta2 * eta2) /
                                  (1603800. * m1Plus3eta2);
  ...
  if (dM2) {
    ...
    coeffs->rho31v3 =
        (chiA * (-4. + 11. * eta) + chiS * dM * (-4. + 13. * eta)) / (6. * dM);
    coeffs->rho31v4 = 101. / 7128. - (5. * a2) / 6. - (1685. * eta) / 1782. -
                      (829. * eta2) / 1782.;
  ...
  coeffs->rho44v3 =
      (chiA * (10. - 39. * eta) * dM + chiS * (10. - 41. * eta + 42. * eta2)) /
      (15. * m1Plus3eta);
  coeffs->rho44v4 =
      a2 / 2. + (-511573572. + 2338945704. * eta - 313857376. * eta2 -
                 6733146000. * eta3 + 1252563795. * eta2 * eta2) /
  ...
  if (dM2) {
    ...
    coeffs->rho43v =
        (5. * (chiA - chiS * dM) * eta) / (8. * dM * (-1. + 2. * eta));
    coeffs->rho43v2 =
  ...
  coeffs->rho42v3 =
      (chiA * (10. - 21. * eta) * dM + chiS * (10. - 59. * eta + 78. * eta2)) /
      (15. * m1Plus3eta);
  coeffs->rho42v4 =
      a2 / 2. + (-114859044. + 295834536. * eta + 1204388696. * eta2 -
                 3047981160. * eta3 - 379526805. * eta2 * eta2) /
                    (317116800. * m1Plus3eta2);
  ...
  coeffs->rho54v2 = (-17448. + 96019. * eta - 127610. * eta2 + 33320. * eta3) /
                    (13650. * (1. - 5. * eta + 5. * eta2));
  ...
  coeffs->rho52v2 = (-15828. + 84679. * eta - 104930. * eta2 + 21980. * eta3) /
                    (13650. * (1. - 5. * eta + 5. * eta2));
  ...
  coeffs->rho66v2 = (-106. + 602. * eta - 861. * eta2 + 273. * eta3) /
                    (84. * (1. - 5. * eta + 5. * eta2));
  ...
  if (dM2) {
    ...
    coeffs->rho65v2 = (-185. + 838. * eta - 910. * eta2 + 220. * eta3) /
                      (144. * (dM2 + 3. * eta2));
  ...
  coeffs->rho64v2 = (-86. + 462. * eta - 581. * eta2 + 133. * eta3) /
                    (84. * (1. - 5. * eta + 5. * eta2));
  ...
  if (dM2) {
    ...
    coeffs->rho63v2 = (-169. + 742. * eta - 750. * eta2 + 156. * eta3) /
                      (144. * (dM2 + 3. * eta2));
  ...
  coeffs->rho62v2 = (-74. + 378. * eta - 413. * eta2 + 49. * eta3) /
                    (84. * (1. - 5. * eta + 5. * eta2));
  ...
  if (dM2) {
    ...
    coeffs->rho61v2 = (-161. + 694. * eta - 670. * eta2 + 124. * eta3) /
                      (144. * (dM2 + 3. * eta2));
  ...
  if (dM2) {
    ...
    coeffs->rho77v2 = (-906. + 4246. * eta - 4963. * eta2 + 1380. * eta3) /
                      (714. * (dM2 + 3. * eta2));
  ...
  if (dM2) {
    ...
    coeffs->rho75v2 = (-762. + 3382. * eta - 3523. * eta2 + 804. * eta3) /
                      (714. * (dM2 + 3. * eta2));
  ...
  if (dM2) {
    ...
    coeffs->rho73v2 = (-666. + 2806. * eta - 2563. * eta2 + 420. * eta3) /
                      (714. * (dM2 + 3. * eta2));
  ...
  if (dM2) {
    ...
    coeffs->rho71v2 = (-618. + 2518. * eta - 2083. * eta2 + 228. * eta3) /
                      (714. * (dM2 + 3. * eta2));
  ...
  if (dM2) {
    coeffs->rho87v2 = (23478. - 154099. * eta + 309498. * eta2 -
                       207550. * eta3 + 38920 * eta2 * eta2) /
  ...
  if (dM2) {
    coeffs->rho83v2 = (20598. - 131059. * eta + 249018. * eta2 -
                       149950. * eta3 + 24520. * eta2 * eta2) /
                      (18240. * (-1. + 6. * eta - 10. * eta2 + 4. * eta3));
  }
  ...
  if (dM2) {
    coeffs->rho81v2 = (20022. - 126451. * eta + 236922. * eta2 -
                       138430. * eta3 + 21640. * eta2 * eta2) /
                      (18240. * (-1. + 6. * eta - 10. * eta2 + 4. * eta3));
  }
 ...
 * to the factorized waveform coefficients. Note that this function only
 * calculates additional terms not present in the flux, so the factorized
 * waveform coefficients SHOULD ALREADY HAVE BEEN CALCULATED using
 * XLALCalcFacWaveformCoefficients() prior to calling this function.
 */
...
static REAL8 nonKeplerianCoefficient(
    const REAL8 *restrict values, /**<< Dynamics r, phi, pr, pphi */
    const REAL8 eta,              /**<< Symmetric mass ratio */
...
UNUSED static int XLALSimIMREOBGetFactorizedWaveform(
    ...
    const REAL8 *restrict values, /**<< Vector containing dynamics r, phi, pr,
  ...
  status = XLALSimIMREOBCalculateNewtonianMultipole(
      &hNewton, vPhi * vPhi, vPhi / Omega, values[1], (UINT4)l, m, params);
  ...
  Tlm = cexp((lnr1.val + LAL_PI * hathatk) +
