...
/** Type codes: use these type codes to identify a LAL atomic data type, see
 * \ref LALDatatypes for more details. */
typedef enum tagLALTYPECODE {
  ...
  LAL_UCHAR_TYPE_CODE =
      LAL_1_BYTE_TYPE_SIZE | LAL_UNSGN_TYPE_FLAG, /**< UCHAR type code (32) */
  LAL_U2_TYPE_CODE =
      LAL_2_BYTE_TYPE_SIZE | LAL_UNSGN_TYPE_FLAG, /**< UINT2 type code (33) */
  LAL_U4_TYPE_CODE =
      LAL_4_BYTE_TYPE_SIZE | LAL_UNSGN_TYPE_FLAG, /**< UINT4 type code (34) */
  LAL_U8_TYPE_CODE =
      LAL_8_BYTE_TYPE_SIZE | LAL_UNSGN_TYPE_FLAG, /**< UINT8 type code (35) */
  LAL_S_TYPE_CODE =
      LAL_4_BYTE_TYPE_SIZE | LAL_FLTPT_TYPE_FLAG, /**< REAL4 type code (18) */
  LAL_D_TYPE_CODE =
      LAL_8_BYTE_TYPE_SIZE | LAL_FLTPT_TYPE_FLAG, /**< REAL8 type code (19) */
  LAL_C_TYPE_CODE = LAL_8_BYTE_TYPE_SIZE | LAL_CMPLX_TYPE_FLAG |
                    LAL_FLTPT_TYPE_FLAG, /**< COMPLEX8 type code (27) */
  LAL_Z_TYPE_CODE = LAL_16_BYTE_TYPE_SIZE | LAL_CMPLX_TYPE_FLAG |
                    LAL_FLTPT_TYPE_FLAG /**< COMPLEX16 type code (28) */
} LALTYPECODE;
...
typedef UINT2Vector
    UINT2Sequence;               /**< See \ref ss_Sequence for documentation */
typedef INT4Vector INT4Sequence; /**< See \ref ss_Sequence for documentation */
typedef UINT4Vector
    UINT4Sequence;               /**< See \ref ss_Sequence for documentation */
typedef INT8Vector INT8Sequence; /**< See \ref ss_Sequence for documentation */
typedef UINT8Vector
    UINT8Sequence; /**< See \ref ss_Sequence for documentation */
typedef REAL4Vector
    REAL4Sequence; /**< See \ref ss_Sequence for documentation */
typedef REAL8Vector
    REAL8Sequence; /**< See \ref ss_Sequence for documentation */
typedef COMPLEX8Vector
    COMPLEX8Sequence; /**< See \ref ss_Sequence for documentation */
typedef COMPLEX16Vector
    COMPLEX16Sequence; /**< See \ref ss_Sequence for documentation */
...
typedef struct tagCHARVectorSequence {
  ...
  CHAR *data; /**< Pointer to the data array.  Element \a i of vector \a j is \c
                 data[ \a jn + \a i \c ]. */
} CHARVectorSequence;
...
typedef struct tagINT2VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  INT2 *data; /**< Pointer to the data array.  Element \a i of vector \a j is \c
                 data[ \a jn + \a i \c ]. */
} INT2VectorSequence;
...
typedef struct tagUINT2VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  UINT2 *data; /**< Pointer to the data array.  Element \a i of vector \a j is
                  \c data[ \a jn + \a i \c ]. */
} UINT2VectorSequence;
...
typedef struct tagINT4VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  INT4 *data; /**< Pointer to the data array.  Element \a i of vector \a j is \c
                 data[ \a jn + \a i \c ]. */
} INT4VectorSequence;
...
typedef struct tagUINT4VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  UINT4 *data; /**< Pointer to the data array.  Element \a i of vector \a j is
                  \c data[ \a jn + \a i \c ]. */
} UINT4VectorSequence;
...
typedef struct tagINT8VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  INT8 *data; /**< Pointer to the data array.  Element \a i of vector \a j is \c
                 data[ \a jn + \a i \c ]. */
} INT8VectorSequence;
...
typedef struct tagUINT8VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  UINT8 *data; /**< Pointer to the data array.  Element \a i of vector \a j is
                  \c data[ \a jn + \a i \c ]. */
} UINT8VectorSequence;
...
typedef struct tagREAL4VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  REAL4 *data; /**< Pointer to the data array.  Element \a i of vector \a j is
                  \c data[ \a jn + \a i \c ]. */
} REAL4VectorSequence;
...
typedef struct tagREAL8VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  REAL8 *data; /**< Pointer to the data array.  Element \a i of vector \a j is
                  \c data[ \a jn + \a i \c ]. */
} REAL8VectorSequence;
...
typedef struct tagCOMPLEX8VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  COMPLEX8 *data; /**< Pointer to the data array.  Element \a i of vector \a j
...
typedef struct tagCOMPLEX16VectorSequence {
  ...
  UINT4 length;       /**< The number \a l of vectors. */
  UINT4 vectorLength; /**< The length \a n of each vector. */
  COMPLEX16 *data; /**< Pointer to the data array.  Element \a i of vector \a j
                      is \c data[ \a jn + \a i \c ]. */
} COMPLEX16VectorSequence;

/* ---------- ArraySequence types ---------- */

/** Sequence of INT2 multidimensional arrays, see \ref ss_ArraySequence for more
 * details. */
typedef struct tagINT2ArraySequence {
  UINT4 length;   /**< The number \a l of vectors. */
  UINT4 arrayDim; /**< The number of data \a N in each array element (this is
                     not the number \a m of indices). */
  UINT4Vector *dimLength; /**< Pointer to a vector of length \a m storing the
                             array dimensions */
  INT2 *data;             /**< Pointer to the data array. */
} INT2ArraySequence;

/** Sequence of UINT2 multidimensional arrays, see \ref ss_ArraySequence for
 * more details. */
...
/** Sequence of INT4 multidimensional arrays, see \ref ss_ArraySequence for more
 * details. */
...
/** Sequence of UINT4 multidimensional arrays, see \ref ss_ArraySequence for
 * more details. */
...
/** Sequence of INT8 multidimensional arrays, see \ref ss_ArraySequence for more
 * details. */
...
/** Sequence of UINT8 multidimensional arrays, see \ref ss_ArraySequence for
 * more details. */
...
/** Sequence of REAL4 multidimensional arrays, see \ref ss_ArraySequence for
 * more details. */
...
/** Sequence of REAL8 multidimensional arrays, see \ref ss_ArraySequence for
 * more details. */
...
/** Sequence of COMPLEX8 multidimensional arrays, see \ref ss_ArraySequence for
 * more details. */
...
/** Sequence of COMPLEX16 multidimensional arrays, see \ref ss_ArraySequence for
 * more details. */
...
typedef struct tagLALUnit {
  ...
  UINT2 unitDenominatorMinusOne[LALNumUnits]; /**< Array of unit power
...
typedef struct tagINT2TimeSeries {
  ...
  REAL8 deltaT; /**< The time step between samples of the time series in
                   seconds. */
...
typedef struct tagINT2TimeVectorSeries {
  ...
  REAL8 deltaT; /**< The time step between samples of the time series of vectors
                   in seconds. */
  REAL8 f0; /**< The heterodyning frequency, in Hertz (zero if not heterodyned).
             */
  LALUnit sampleUnits; /**< The physical units of the quantity being sampled. */
...
typedef struct tagLALStatus {
  INT4 statusCode; /**< A numerical code identifying the type of error, or 0 for
                      nominal status; Negative values are reserved for certain
                      standard error types */
  const CHAR *statusDescription; /**< An explanatory string corresponding to the
                                    numerical status code */
  volatile const CHAR
      *Id; /**< A character string identifying the source file and version
              number of the function being reported on */
  const CHAR *function; /**< The name of the function */
  const CHAR
      *file; /**< The name of the source file containing the function code */
  INT4 line; /**< The line number in the source file where the current \c
                statusCode was set */
  struct tagLALStatus
      *statusPtr; /**< Pointer to the next node in the list; \c NULL if this
                     function is not reporting a subroutine error */
